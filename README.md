...
The project is a sample todo app written in React.  It was used during a presentation.  The slides for the talk can be found [here](https://docs.google.com/presentation/d/116Ndc1lCV8r1z46jcOzZPzhymxB8eCMNTi5kYeorWKY/edit?usp=sharing).  The presentation was part of the [East Bay JS Meetup](https://www.meetup.com/eastbayjavascript/)

### Running the Application

To run the app, open a terminal window in the root of this project and run:
